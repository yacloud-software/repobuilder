...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3202
	golang.conradwood.net/apis/buildrepo v1.1.3067
	golang.conradwood.net/apis/common v1.1.3202
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.3202 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.3202 // indirect
